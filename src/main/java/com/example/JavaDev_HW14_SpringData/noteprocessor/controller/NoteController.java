package com.example.JavaDev_HW14_SpringData.noteprocessor.controller;
...
import com.example.JavaDev_HW14_SpringData.noteprocessor.service.NoteService;
...
public class NoteController {
    ...
    @PostMapping("/create")
    public String saveCreateNote(@ModelAttribute("note") Note note) throws NoteProcessingExceptions {
